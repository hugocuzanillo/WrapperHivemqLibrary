...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Returns the group of libraries at mqtt
     */
    ...
    public static class MqttLibraryAccessors extends SubDependencyFactory {

        public MqttLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for flow ( com.github.hugocuzanillo:MqttFlow)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getFlow() {
                return create("mqtt.flow");
        }
    ...
    public static class OrgLibraryAccessors extends SubDependencyFactory {
        ...
        public OrgLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> getBouncycastle() {
                return create("org.bouncycastle");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.mqtt
         */
    ...
    public static class MqttVersionAccessors extends VersionFactory  {

        public MqttVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: mqtt.flow (1.0.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getFlow() { return getVersion("mqtt.flow"); }
    ...
    public static class OrgVersionAccessors extends VersionFactory  {
        ...
        public OrgVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: org.bouncycastle (1.67)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
