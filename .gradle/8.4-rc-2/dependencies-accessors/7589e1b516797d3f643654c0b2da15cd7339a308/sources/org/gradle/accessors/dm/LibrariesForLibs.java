...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class WrapperLibraryAccessors extends SubDependencyFactory {
        ...
        public WrapperLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for mqtt (com.github.hugocuzanillo:WrapperMqtt)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getMqtt() {
                return create("wrapper.mqtt");
        }
    ...
    public static class WrapperVersionAccessors extends VersionFactory  {
        ...
        public WrapperVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: wrapper.mqtt (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getMqtt() { return getVersion("wrapper.mqtt"); }
