...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final WrapperLibraryAccessors laccForWrapperLibraryAccessors = new WrapperLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at wrapper
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public WrapperLibraryAccessors getWrapper() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForWrapperLibraryAccessors;
    }
    ...
    public static class HivemqMqttLibraryAccessors extends SubDependencyFactory {
        ...
        public HivemqMqttLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for client (com.github.hivemq.hivemq-mqtt-client:hivemq-mqtt-client)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
     ...
     */
    @Deprecated
    public static class WrapperLibraryAccessors extends SubDependencyFactory {
        private final WrapperHivemqLibraryAccessors laccForWrapperHivemqLibraryAccessors = new WrapperHivemqLibraryAccessors(owner);

        public WrapperLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at wrapper.hivemq
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public WrapperHivemqLibraryAccessors getHivemq() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForWrapperHivemqLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class WrapperHivemqLibraryAccessors extends SubDependencyFactory {

        public WrapperHivemqLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for library (com.github.hugocuzanillo.WrapperHivemqLibrary:WrapperHivemqLibrary)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("wrapper.hivemq.library");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final WrapperVersionAccessors vaccForWrapperVersionAccessors = new WrapperVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.wrapper
         */
        public WrapperVersionAccessors getWrapper() {
            return vaccForWrapperVersionAccessors;
        }
    ...
    public static class HivemqVersionAccessors extends VersionFactory  {
        ...
        private final HivemqMqttVersionAccessors vaccForHivemqMqttVersionAccessors = new HivemqMqttVersionAccessors(providers, config);
        public HivemqVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.hivemq.mqtt
         */
        public HivemqMqttVersionAccessors getMqtt() {
            return vaccForHivemqMqttVersionAccessors;
        }

    }

    public static class HivemqMqttVersionAccessors extends VersionFactory  {

        public HivemqMqttVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: hivemq.mqtt.client (1.3.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getClient() { return getVersion("hivemq.mqtt.client"); }
    ...
    public static class WrapperVersionAccessors extends VersionFactory  {

        private final WrapperHivemqVersionAccessors vaccForWrapperHivemqVersionAccessors = new WrapperHivemqVersionAccessors(providers, config);
        public WrapperVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.wrapper.hivemq
         */
        public WrapperHivemqVersionAccessors getHivemq() {
            return vaccForWrapperHivemqVersionAccessors;
        }

    }

    public static class WrapperHivemqVersionAccessors extends VersionFactory  {

        public WrapperHivemqVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: wrapper.hivemq.library (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getLibrary() { return getVersion("wrapper.hivemq.library"); }
